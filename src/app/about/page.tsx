    ...
    <div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className={historyImage ? '' : 'md:col-span-2'}>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>Founded in 2018 by Dr. Evelyn Reed, a veteran HR professional, Skillbridge started as a weekend resume workshop for local college students. Witnessing the immediate impact of targeted career guidance, the initiative quickly grew.</p>
                <p>By 2020, we launched our first mentorship program, connecting students with industry professionals. Today, Skillbridge offers a comprehensive suite of services, empowering hundreds of individuals annually to navigate the job market with confidence.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-100 dark:bg-gray-800 py-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground">Skillbridge is a registered non-governmental organization.</p>
